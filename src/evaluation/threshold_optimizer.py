...
class ThresholdOptimizer:
    ...
    def find_optimal_threshold(self, methods: Optional[List[str]] = None) -> Dict[str, any]:
        ...
        consensus_metrics = self.calculate_metrics_at_threshold(consensus_threshold)
